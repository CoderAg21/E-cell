🌟This is simplle HTML, CSS, JAVASCRIPT webssite made to complete the task provided by the E-cell club of MNNIT PRAYAGRAJ, ALLAHABAD.

🌟This is a responsive website can e run in any of devices.

🌟It is based on the Squid Game theme.So,lets explore the website.

🌟There is also a grid of 3*3 in which if you click on any of the cell the colour changes to "Red" and when when you click the last element of
last row and last column then you will see that the red colour will changes to again the original colour in the order of ascending i.e;
